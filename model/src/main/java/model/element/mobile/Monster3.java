...
public class Monster3 extends Mobile implements ISprite{
	
	/** The Constant SPRITE. */
    private static final ISprite sprite          = new Sprite('@', "monster_3.png");

    /** The Constant spriteDie. */
    private static final ISprite spriteDie  = new Sprite('@', "noimage.png");

    /**
     * Instantiates a new Monster3.
     *
     * @param x
     *            the x
     * @param y
     ...
     */
    public Monster3(final int x, final int y, final ILevel level) throws IOException {
